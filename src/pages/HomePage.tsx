...
const Homepage = () => {
  ...
  const [coinToTransfer, setCoinToTransfer] = useState(0)
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <p className="text-2xl font-bold text-gray-900">${(noc * 100).toFixed(8)}</p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <p className="text-sm text-gray-500 mt-1">= ${(noc * 100).toFixed(8)}</p>
              </div>
