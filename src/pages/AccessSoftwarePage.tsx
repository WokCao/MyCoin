import { AlertTriangle, Check, Code, Eye, EyeOff, FileText, Key, Laptop, X } from "lucide-react";
        ...
        const handleAccessWallet = () => {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    // Optional: set address from file
                            ...
                            <div className="flex flex-col items-center gap-4">
                                ...
                                <div className="flex gap-2 justify-center">
                                    ...
                                    <button
                                        ...
                                        className={`${!password ? 'bg-gray-300 text-white font-medium hover:cursor-not-allowed' : 'bg-teal-400 hover:bg-teal-500 text-white'} rounded-lg px-8 py-2 text-xs lg:text-sm hover:cursor-pointer`}
                                    >
                                        Access Wallet
                                    </button>
                                </div>
